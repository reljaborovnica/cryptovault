  ...
  <body>
    ...
    <div class="container">
      <div class="form-container">
        ...
        <a href="add-cbs" style="text-decoration: none; color: #ffffffdb; padding: 12px 24px; background-color: #88ac81; border-radius: 2px; border: 3px solid #63885c; font-weight: bold; text-transform: uppercase; transition: background-color 0.3s ease;">Add Multiple Control Boards</a>
