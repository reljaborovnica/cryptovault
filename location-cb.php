   ...
   <div class="table-container">
        ...
        if(isset($_GET['id'])){
                        ...
                        <tr>
                            <form method="POST" action="">
                                ...
                                <td class="operations">
                                    ...
                                    <a href="location-cb.php?delete=<?php echo $cb_id;?>" class="myLink">❌</a>
                                </td>
                            </form>
                        </tr>
                    <?php } ?>
            ...
            <?php
                ...
                echo "<H1><center>Location does not contain any control boards currently</center></H1>";
            }
        }
        ?>
    </div>
...
if(isset($_POST['export'])){
  $cb_file = 'exports/' . $data[0]['location_name'] . '_CBs_' . date('Y-m-d') . '.xlsx';
