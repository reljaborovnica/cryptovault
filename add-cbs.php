...
<head>
    ...
    <title>CryptoVault - Add CBS</title>
</head>
<body>
...
?>
    ...
    <h2>Insert Multiple Control Boards</h2>
        
    <form class="container" onsubmit="return confirmSubmit();" method="POST" action="./functions/add-cbs-data.php">
        ...
        <div style="display: flex; justify-content: center; align-items: flex-end;">
            ...
            <input type="submit" value="Add CBs" style="width: auto; height: 50px; margin: 0 10px;">
