   ...
   <div class="table-container">
        ...
        if(isset($_GET['id'])){
                        ...
                        <tr>
                            <form method="POST" action="">
                                ...
                                <td class="operations">
                                    ...
                                    <a href="location-miner.php?delete=<?php echo $miner_id;?>" class="myLink">❌</a>
                                </td>
                            </form>
                        </tr>
                    <?php } ?>
            ...
            <?php
                ...
                echo "<H1><center>Location does not contain any miners currently</center></H1>";
            }
        }
        ?>
    </div>
...
if(isset($_POST['export'])){
  $miner_file = 'exports/' . $data[0]['location_name'] . '_Miners_' . date('Y-m-d') . '.xlsx';
