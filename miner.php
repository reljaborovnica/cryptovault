    ...
    <div style="text-align: center;">
      ...
      <div style="text-align: center;">
        ...
        <div style="display: inline-block; margin-left: 10px;">
          <div style="text-align: center;">
            <button id="updateAllMiners" style="font-family: 'Roboto'; background-color: #4CAF50; color: white; padding: 10px 20px; border: none; cursor: pointer; border-radius: 5px;">Update All Fields</button>
          </div>
        </div>
