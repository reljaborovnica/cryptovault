        ...
        <div class="table-container">
            ...
            if(isset($_GET['search'])){
                ...
                $get_miner_data = 
                  "
                    SELECT 
                      m.miner_id, m.miner_sn, m.miner_model, m.customer_id , m.miner_label, m.psu_model, 
                      m.psu_sn, l.location_name, l.location_id, c.customer_id, c.customer_name, m.miner_condition
                    FROM miners m
                ...
                <?php
                    ...
                    echo "<H1><center>No miners found</center></H1>";
                }
            }
            ?>
        </div>
    ...
    <div style="text-align: center;">
      ...
      <div style="text-align: center;">
        ...
        <div style="display: inline-block; margin-left: 10px;">
          <div style="text-align: center;">
            <button id="updateAllMiners" style="font-family: 'Montserrat'; font-weight: 600; background-color: #88ac81; color: #ffffffdb; padding: 10px 20px; border: none; cursor: pointer; border-radius: 5px;">Update All Fields</button>
          </div>
        </div>
...
$get_miner_data_xlsx =
              "
                ...
                SELECT 
                  m.miner_label, m.miner_sn, m.miner_model, m.psu_model, m.psu_sn, l.location_name, c.customer_name, m.miner_condition
                FROM miners m
                  JOIN locations l ON m.location_id = l.location_id
                  JOIN customers c ON m.customer_id = c.customer_id;
...
if(isset($_POST['export'])){
  $miner_file = 'exports/' . 'Miners_' . date('Y-m-d') . '.xlsx';
