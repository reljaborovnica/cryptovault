   ...
   <div class="table-container">
        ...
        if(isset($_GET['id'])){
                        ...
                        <tr>
                            <form method="POST" action="">
                                ...
                                <td class="operations">
                                    ...
                                    <a href="customer-fan.php?delete=<?php echo $fan_id;?>" class="myLink">❌</a>
                                </td>
                            </form>
                        </tr>
                    <?php } ?>
            ...
            <?php
                ...
                echo "<H1><center>The customer doesn't own any fans</center></H1>";
            }
        }
        ?>
    </div>
...
if(isset($_POST['export'])){
  $fan_file = 'exports/' . $data[0]['customer_name'] . '_Fans_' . date('Y-m-d') . '.xlsx';
