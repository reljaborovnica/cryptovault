    ...
    <div style="text-align: center;">
      ...
      <div style="text-align: center;">
        ...
        <div style="display: inline-block; margin-left: 10px;">
          <div style="text-align: center;">
            <button id="updateAllCbs" style="font-family: 'Montserrat'; font-weight: 600; background-color: #88ac81; color: #ffffffdb; padding: 10px 20px; border: none; cursor: pointer; border-radius: 5px;">Update All Fields</button>
          </div>
        </div>
