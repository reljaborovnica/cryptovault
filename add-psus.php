...
?>
    ...
    <h2>Insert Multiple PSUs</h2>

    <form class="container" onsubmit="return confirmSubmit();" method="POST" action="./functions/add-psus-data.php">
        ...
        <div style="display: flex; justify-content: center; align-items: flex-end;">
            ...
            <input type="submit" value="Add power supplies" style="width: auto; height: 50px; margin: 0 10px">
        </div>
    </form>
